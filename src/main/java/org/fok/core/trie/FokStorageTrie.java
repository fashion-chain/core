...
@Slf4j
public class FokStorageTrie implements ActorService {
	...
	public FokStorageTrie(FokAccountDataAccess accountDA, ICryptoHandler cryptoHandler) {
	...
	public boolean equals(Object o) {
		...
		FokStorageTrie oStorageTrie = (FokStorageTrie) o;

		return BytesComparisons.equal(getRootHash(), oStorageTrie.getRootHash());
